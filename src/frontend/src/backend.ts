...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Product as _Product, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: bigint | null, arg5: string, arg6: bigint, arg7: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(arg0, arg1, arg2, arg3, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), arg5, arg6, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: bigint | null, arg5: string, arg6: bigint, arg7: ExternalBlob, arg8: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, arg3, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), arg5, arg6, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg7), arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        originalPrice: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.originalPrice)),
        name: value.name,
        description: value.description,
        isActive: value.isActive,
        stock: value.stock,
        imageUrl: await from_candid_ExternalBlob_n24(_uploadFile, _downloadFile, value.imageUrl),
